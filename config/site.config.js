...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'winston@w6vxp.onmicrosoft.com',
  ...
  email: 'mailto:winston@w6vxp.onmicrosoft.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/linkcccp',
    },
  ],
